...
6. Check the boxes next to **myVM1**, **myVM2**, and **myVM3**. --> These 3 VMs are already added to "myBackendPool" adding them again to "myBackendPoolOutloob will raise an error regarding a conflict with NicUpdate
